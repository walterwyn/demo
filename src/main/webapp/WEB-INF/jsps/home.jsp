...
<html>
  <head>
    ...
    <title>百度效率云Demo</title>
    <meta name="description" content="" />

    <spring:url value="/css/gradients.css" var="gradientsCss" />
    <spring:url value="/css/styles.css" var="stylesCss" />
    <spring:url value="/js/set-background.js" var="setBackgroundJs" />
    <spring:url value="/js/tweet.svg" var="tweetSvg" />
  ...
  <body class="">
    <div class="wrapper">
      ...
      <header>
        <nav class="website-nav">
          <ul>
            <li><a class="home-link" href="https://www.baidu.com/">Home</a></li>
            <li><a href="https://www.baidu.com/">About</a></li>
            <li><a href="https://www.baidu.com/">Services</a></li>
      ...
      <div class="message">
          <a class="twitter-link" href="http://www.baidu.com">
              <img src="/js/baidu.svg" alt="Baidu"/>
          </a>
        <div class="text">
          <h1>Welcome to baidu efficiency cloud hahahhahaha !</h1>
		  <h2>${name}</h2>
        </div>
      </div>
    </div>
    ...
    <footer>
      <p class="footer-contents">Designed and developed with <a href="https://www.baidu.com/">xiaolvyun</a></p>
    </footer>
